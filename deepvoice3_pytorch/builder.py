...
def deepvoice3(
  ...
  encoder = Encoder(
    ...
    convolutions=[
      (h, k, 1), (h, k, 3), (h, k, 9), (h, k, 27), (h, k, 1), (h, k, 3), (h, k, 9), (h, k, 27), (h, k, 1), (h, k, 3)
    ],
  )
...
def nyanko(
  ...
  converter = Converter(
    in_dim=in_dim, out_dim=linear_dim, channels=converter_channels, kernel_size=kernel_size, dropout=dropout
  )
