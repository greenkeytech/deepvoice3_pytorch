#!/bin/python3
"""
Grabs transcripts of things that ought to be transcribed as quotes so we can use these for quote classification
"""
...
os.popen("mkdir -p buggy").read()


def move_files(ifl):
  txt = ifl.replace(".phones", ".txt")
  os.popen("cp " + txt + " buggy/").read()
